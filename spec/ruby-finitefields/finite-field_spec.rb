...
RSpec.describe GF do
  ...
  describe GF::GF do
    before do
      ...
      @_1 = @pf2.one
      @po2 = GF::Poly.new(@pf2)
      @gen1 = @po2.new([@_1,@_0,@_0,@_0,@_1,@_0,@_0,@_0,@_0,@_1])
      @gen2 = @po2.new([@_1,@_0,@_0,@_0,@_0,@_1,@_0,@_0,@_0,@_1])
    ...
    describe '#add' do
      it '1 + 1 = 0' do
        expect( @gf256.new(0b1) + @gf256.new(0b1) ).to eq @gf256.new(0b0)
      end
      it '(x+1) + x = 1' do
        expect( @gf256.new(0b11) + @gf256.new(0b01) ).to eq @gf256.new(0b1)
      end
      it '(xx+1) + (x+1) = xx+x' do
        expect( @gf256.new(0b0101) + @gf256.new(0b0011) ).to eq @gf256.new(0b0110)
      end
    end

    describe '#mult' do
      it 'x * x = xx' do
        expect( @gf256.new(0b0010) * @gf256.new(0b0010) ).to eq @gf256.new(0b0100)
      end
      it '(x+1) * x = xx+x' do
        expect( @gf256.new(0b0011) * @gf256.new(0b0010) ).to eq @gf256.new(0b0110)
      end
      it '(x+1) * (xx+x+1) = xxx+1' do
        expect( @gf256.new(0b0011) * @gf256.new(0b0111) ).to eq @gf256.new(0b1001)
      end
    end
    ...
    describe '#minus' do
      it 'returns inverse in addition' do
        ...
        expect( @gf256.new(0b1100) + (-@gf256.new(0b1100)) ).to eq @gf256.zero
        expect( @gf256.new(0b10100011) + (-@gf256.new(0b10100011)) ).to eq @gf256.zero
      end

      it '-x = x' do
        expect( -(@gf256.new(0b0010)) ).to eq @gf256.new(0b0010)
      end
      it '-(xx+1) = xx+1' do
        expect( -(@gf256.new(0b0101)) ).to eq @gf256.new(0b0101)
      end
    end
    ...
    describe '#inv' do
      ...
      it '2^-1 = 4 mod 7' do
        expect( @gf256.new(2).inv ).to eq @gf256.new(4)
      end
